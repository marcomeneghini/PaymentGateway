...
The Merchant entity has a GUID as PK BUT is not autogenerated in this database because it would come from an hypothetical "Merchant.Api" microservice 
that manage (so also creates) the merchants, therefore generating the GUID itself.
