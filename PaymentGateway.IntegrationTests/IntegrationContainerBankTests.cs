...
{
    public  class IntegrationContainerBankTests : IClassFixture<IntegrationContainerBankTestFixture<PgApi.Startup, PgProcessorApi.Startup>>
    {
        ...
        public IntegrationContainerBankTests(IntegrationContainerBankTestFixture<PgApi.Startup, PgProcessorApi.Startup> fixture)
        {
